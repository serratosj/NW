...
module.exports = {
  'Add Patient (Admin)' : function (browser) {
   ...
   var counselorname = browser.globals.counselor.name;
  ...
  /*Login*/
    ...
    .maximizeWindow()
      ...
      .waitForElementVisible('input[value="'+patient.gender+'"]', 10000)
      .click('input[value="'+patient.gender+'"]')
      ...
      .click('option[label="'+counselorname+''+' '+''+counselorlastname+'"]')
      .pause(1000)
	  
	  /* Other Accessors */
	  .waitForElementVisible('input[name="idAccessors"]', 10000)
	  .setValue('input[name="idAccessors"]', "")
